import 'package:best_flutter_ui_templates/fitness_app/dialog/water_dialog.dart';
...
class _WaterViewState extends State<WaterView> with TickerProviderStateMixin {
  ...
  bool isLoadingWaterUp = false;
  bool isLoadingWaterDown = false;
            ...
            child: Padding(
              ...
              child: GestureDetector(
                onTap: () async {
                  await showDialog(
                    context: context,
                    builder: (BuildContext context) => WaterDialog(
                      mili: waterToDay.ml,
                      ...
                      children: <Widget>[
                        ...
                        Padding(
                          ...
                          child: Container(
                            ...
                            child: WaveView(
                                percent: waterToDay.per,
                                waterlv: waterToDay.lv),
                          ),
                        )
                      ],
                    ),
